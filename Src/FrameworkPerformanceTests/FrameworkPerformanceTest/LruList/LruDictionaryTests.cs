...
namespace FrameworkPerformanceTest.LruList
{
    ...
    {
        private LruDictionary<string, CacheItem> _cache;

        public LruDictionaryTests()
        {
        }

        [Benchmark(Description = "LruDictionary encode speed")]
        public void SetSpeedTest()
        {
            _cache = new LruDictionary<string, CacheItem>(Config.QueueSize);
        ...
        [Benchmark(Description = "LruDictionary double encode speed")]
        ...
        [Benchmark(Description = "LruDictionary encode/Get speed")]
        ...
        [Benchmark(Description = "LruDictionary double encode/Get speed")]
        ...
        [Benchmark(Description = "Parallel LruDictionary enqueue / Get task")]
